...
public class SMEditLauncher
{
    ...
    public SMEditLauncher(String[] args)
    {
        mArgs = args;
	...
	private void runSMEdit()
    {
        try
        {
            ...
            URLClassLoader smLoader = new URLClassLoader(new URL[]{josmURL,smURL}, SMEditLauncher.class.getClassLoader());            
    ...
    {
        SMEditLauncher app = new SMEditLauncher(args);
        app.run();
    }
