...
public class ImportSTLPlugin implements IBlocksPlugin
{
    public static final String NAME = "Import/STL";
    public static final String DESC = "Import STL file";
    ...
    {
        return new ImportSTLParameters();
    }
	@Override
