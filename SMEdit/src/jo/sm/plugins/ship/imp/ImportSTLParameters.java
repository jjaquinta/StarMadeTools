...
@Description(displayName="Import STL Model", shortDescription="Import a model in Standard Tessellation Language format from your disk")
public class ImportSTLParameters
{
	@Description(displayName="File", shortDescription="Path to STL model")
    private String  mFile;
	@Description(displayName="Longest Dimension", shortDescription="Scale the model to this size")
    private int   mLongestDimension;
    
    public ImportSTLParameters()
    {
