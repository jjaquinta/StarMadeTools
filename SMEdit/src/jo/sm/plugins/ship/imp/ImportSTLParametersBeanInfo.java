...
public class ImportSTLParametersBeanInfo implements BeanInfo
{
    private BeanInfo mRootBeanInfo;
    private FilePropertyInfo	mInfo;
    
    public ImportSTLParametersBeanInfo() throws IntrospectionException
    {
        super();
        mInfo = new FilePropertyInfo();
        mInfo.setDialogTitle("Import from STL file");
        mInfo.setFilters(new String[][]{
        		{ "Standard Tessellation Language STL file", "stl" },
        });
        ...
        mRootBeanInfo = Introspector.getBeanInfo(ImportSTLParameters.class, Introspector.IGNORE_IMMEDIATE_BEANINFO);
    }
